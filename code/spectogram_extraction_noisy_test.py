...
data_path = "../data/"
noisy = pd.read_csv(data_path+"test_noisy.csv")
...
for index,rows in tqdm(noisy.iterrows()):
    if True:
        ...
        try:
            ...
            image_path_colorbar = "../data/test_noisy/colorbar/"
            image_path_simple = "../data/test_noisy/simple/"
